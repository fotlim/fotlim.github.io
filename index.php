<?php
/**
 * 这是一个专门用来分享电影的Typecho个人定制主题。<br>本主题由<a href="https://www.typecho.wiki/" target="_blank" rel="noopener noreferrer">Typecho.wiki</a>负责分发<br><a href="https://www.typecho.wiki/typecho-niche-tool-daily-movie-recommendation-theme-onemday.html" target="_blank" style="background: #000;padding: 2px 4px;color: #ffeb00;font-size: 12px;" rel="noopener noreferrer">使用说明</a> - <a href="https://www.typecho.wiki/typecho-niche-tool-daily-movie-recommendation-theme-onemday.html#comments" target="_blank" style="background: #000;padding: 2px 4px;color: #ffeb00;font-size: 12px;" rel="noopener noreferrer">Bug反馈</a> - <a href="https://www.bawge.com" target="_blank" style="background: #b94a48;padding: 2px 4px;color: #ffffff;font-size: 12px;" rel="noopener noreferrer">作者网站</a> - <a href="https://www.typecho.wiki/category/themes/" target="_blank" style="background: #000;padding: 2px 4px;color: #ffeb00;font-size: 12px;" rel="noopener noreferrer">更多Typecho主题</a>
 *
 * @package Onemday-每日一片
 * @author Meayair
 * @version 1.0
...
<head>
    ...
    <title>列表-<?php $this->options->title(); ?></title>
...
<body>
    ...
    <div id="searchArea" style="width: 100%;height: 100%;position: fixed;top: 0;background: #181818;z-index: 999;display:none;color: white;">
        ...
        <form action="<?php $this->options->siteUrl(); ?>" method="GET" target="_blank" id='searchForm' style="width: 80%;max-width: 800px; margin: auto;margin-top: calc(50vh - 260px);">
            <input id="search" name="s" type="text" placeholder="输入电影名称进行搜索..." autocomplete="off" autofocus>
    ...
    <a class='today-btn' onclick="showsearchArea()" href="javascript:;">搜索</a>
    <div id='content-wrap'>
        <?php while ($this->next()) : ?>
            <div class='day-wrap'>
                <div class='left-box'>
